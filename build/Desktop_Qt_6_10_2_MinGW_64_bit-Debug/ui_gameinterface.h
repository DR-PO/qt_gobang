...
public:
    ...
    void setupUi(QMainWindow *GameInterface)
    {
        ...
        pushButton_surrend->setObjectName("pushButton_surrend");
        pushButton_surrend->setGeometry(QRect(720, 490, 91, 41));
        image_player = new QLabel(centralwidget);
        image_player->setObjectName("image_player");
        ...
        image_competitor->setObjectName("image_competitor");
